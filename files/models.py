...
class FinishWork(models.Model):
    ''' Модель финишная обработка для баннеров
    '''
    ...
    price_agent = models.FloatField(
        max_length=100,
        help_text="Цена за 1 м. погонный",
        verbose_name="Стоимость работы в руб.",
    )  # Стоимость в продаже для РА
    ...
    price_customer_retail = models.FloatField(
        ...
        null=True,
        blank=True,
    )  # Стоимость в продаже для розницы
